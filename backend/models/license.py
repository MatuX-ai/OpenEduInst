...
class OrganizationType(str, enum.Enum):
    """组织类型枚举"""
    TRAINING = "training_institution"      # 培训机构
    K12 = "k12_school"                     # K12学校
    VOCATIONAL = "vocational_school"       # 职业学校
    BUREAU = "education_bureau"            # 教育局
...
class Organization(Base):
    ...
    # 组织类型
    org_type = Column(Enum(OrganizationType), default=OrganizationType.TRAINING, index=True)
