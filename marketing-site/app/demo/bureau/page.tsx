...
export default function DemoBureau() {
  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <header className="border-b border-slate-800 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 text-xs bg-orange-600 hover:bg-orange-500 text-white rounded-lg transition-colors"
          >
            新窗口打开
      ...
      <div className="w-full" style={{ height: "calc(100vh - 60px)" }}>
        <iframe
          src="http://localhost:4200/organization/4/dashboard"
          className="w-full h-full border-0"
          title="OpenMT Demo - Education Bureau"
      ...
      <div className="fixed bottom-6 right-6 max-w-sm p-4 bg-slate-800 border border-slate-700 rounded-lg shadow-xl">
        ...
        <div className="space-y-1 text-xs text-slate-400">
          <p>局长：wang_director / demo123456</p>
          <p>督导员：li_inspector / demo123456</p>
          <p>教研员：zhang_researcher / demo123456</p>
        </div>
