...
import { Settings, Shield, Key, Database, Wrench, BookOpen } from "lucide-react";
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div className="p-5">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { role: "实训主任", user: "liu_director", pass: "demo123456", color: "emerald" },
              { role: "任课教师", user: "zhang_teacher", pass: "demo123456", color: "blue" },
        ...
        {[
          {
            ...
            items: [
              { label: "系统角色", value: "3 种", desc: "主任/教师/学生" },
              { label: "当前在线", value: "—", desc: "演示模式无实时数据" },
              { label: "操作日志保留", value: "180 天" },
            ],
          },
          {
            icon: Wrench, title: "实训配置",
            items: [
              { label: "实训设备总数", value: `${mockData.stats.totalDevices} 台` },
              { label: "实训室数量", value: "5 间" },
              { label: "合作企业", value: `${mockData.stats.enterprisePartners} 家` },
            ],
          },
          {
            icon: BookOpen, title: "教务信息",
            items: [
              { label: "当前学期", value: mockData.academic.currentSemester },
              { label: "实训班数", value: `${mockData.academic.totalClasses} 个` },
              { label: "周实训课时", value: `${mockData.academic.weeklySessions} 节` },
            ],
          },
        ].map((section, i) => (
